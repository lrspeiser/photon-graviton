...
| **Supply audit, CC-2 stage 1** ([report](research_work/results/companion-supply/report.md)), diagnostic | Is CF-1's incoming bath consistent at the supply CF-1 requires? Covers bath scattering, bath gravity, travel times, particle against wave, velocity distributions, and the channels CF-1 omitted under its own law | **No: the bath would be the dominant, self-gravitating medium.** Its optical depth across the boundary region is 4–8 (Milky Way, Coma). For σ/m of 0.1–1,000 cm²/g it outweighs the baryons there by 10¹–10⁷, and in Coma it is Jeans-unstable at every trial scattering strength. Seedless capture between two incoming companions beats seeded capture by 10²–10⁷. Retention needs a bath dispersion below about 210 km/s (Milky Way) or 510–700 km/s (Coma) |
...
- **CC-2, stage 1.** At the supply CF-1 requires, its bath would be opaque, outweigh the baryons, and in Coma collapse on its own. It is effectively a self-interacting dark-matter medium, not a trace background. Seedless capture dominates. The depth selectivity survives Maxwellian baths, but the fast tail decides galaxies. Whether such a medium fits the project's premises is the owner's decision.
...
1. **CC-2, cosmological supply.** Given a declared field state and interaction, what traveling population is produced, and how does extracting that energy change the field's evolution? The clock field's store holds all the energy light has lost since the turnaround. Matching about 26% of 3H²c²/8πG would need z ≈ 5,200, which is a required-budget estimate, not evidence.
   It runs in three stages, the owner's order:
   1. a regime and supply audit of CF-1's bath: done ([report](research_work/results/companion-supply/report.md)). At the required supply the bath would be opaque, outweigh the baryons and collapse on its own, and seedless capture dominates;
   2. one declared source interaction predicting the companions' density and full velocity distribution, with the source field's energy loss and back-reaction;
   3. a small coupled formation test (Milky Way and both Coma brackets), evolving mass, energy, escaping companions and gravity together. It includes a zero-seed control, and must include the bath's own gravity and collisions, which stage 1 shows cannot be neglected.
