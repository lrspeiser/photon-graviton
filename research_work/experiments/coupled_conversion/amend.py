"""Immutable runner for the declared refinement or unusual-law screen."""
...
def main():
    p=argparse.ArgumentParser();p.add_argument('--stage',choices=['refinement','explore'],required=True)
