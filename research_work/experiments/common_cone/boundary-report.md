...
Next test a boundary treatment with the massive term, all3D directions/corners and the relevant weak exterior field speeds, retaining energy/flux accounting. OB-2 evolves derivative variables; it does not validate an absolute scalar-potential value or clock offset. Reconstructing that field consistently also needs verification. A single pulse spectrum and incidence direction do not establish those results. The isolated/outgoing part of requirement3 is therefore still open, even though OB-2 supplies a working vacuum component. No dark matter, expansion or observational fit was involved.
