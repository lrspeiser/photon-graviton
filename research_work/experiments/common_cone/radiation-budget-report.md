...
Independent audit: audit_radiation_budget.py passes 102 checks, including decimal-arithmetic budget reconstruction and direct field-Hamiltonian derivative verification of the active coefficient (maximum scaled error 5.40e-11). For a fresh numerical reproduction without deleting evidence, use a separate checkout at implementation commit 703b8d6, before radiation-budget-v1 was added, and run radiation_budget.py there.
