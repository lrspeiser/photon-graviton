...
The finest three-dimensional refinement changes the added force by at most **0.2580%** on 60 fixed spatial probes (median 0.001004%). Separately refining the axisymmetric reference changes it by at most **0.0188%**; moving the outer source boundary from 80 to 100 kpc changes it by at most **0.0152%**. These are finite numerical comparisons, not proofs of continuum accuracy or observational tolerances.
...
|---:|---:|---:|---:|---:|---:|---:|
| 3 | 0.1 | 0 deg | -3448.781 | 0.000 | -1301.512 | 16.590% |
| 3 | 0.1 | 30 deg | -3214.762 | -787.009 | -780.531 | 23.849% |
| 3 | 0.1 | 90 deg | -3060.538 | -0.000 | -655.243 | 6.394% |
| 3 | 0.8 | 0 deg | -3016.717 | 0.000 | -3328.300 | 19.017% |
| 3 | 0.8 | 30 deg | -2953.838 | -539.869 | -2608.840 | 13.790% |
| 3 | 0.8 | 90 deg | -2875.814 | -0.000 | -2268.082 | 8.312% |
...
- Direct finite differences of the potential agree with its force to 2.27e-08 maximum relative error on the probes. Reflection symmetry agrees to 1.4e-15.
- All three checked maximum force changes are below the provisional 1% target: **True**. A true value applies only to the listed spatial probes, numerical variations and fixed ordinary-matter representation.
