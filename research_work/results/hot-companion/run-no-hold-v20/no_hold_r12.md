# Regression suite: no_hold_r12 (full tier)

Law: a = 6.2979e-11 m/s^2; g_d = 2.0273e-10 m/s^2 (lambda 3.219); u = 169.4 km/s; reach 2.25 Mpc; gradual release over 2e+05 AU; external hold x0; distance scale alpha x0.9500 (H0-like 70.9); SPARC distances static

Round 20: round 9's no_hold rerun on today's law and inputs as a registered comparison (not adopted). The outside galaxy's pull and heat do not enter a separate system's own law (external hold 0: dwarf galaxies, the Sun, wide binaries), with the release length raised to 1 pc (2 x 10^5 AU) as in round 9. Not derived.

Run 2026-09-25 14:47 UTC on commit 67075c2+changes, 603 s. Baseline: baseline.json (round12, full, 2026-09-24 04:37 UTC).
...
| vs baseline: worse | 3 |
| vs baseline: better | 5 |
| vs baseline: changed | 2 |
| vs baseline: new | 0 |
| vs baseline: known | 2 |
| vs baseline: error | 0 |
...
| Check | Ours | Measured / required | Status | vs baseline |
|---|---:|---|---|---|
| Draco: stars' speed spread | 4.103 km/s | 9.1 +- 1.2 | fail | better (was 2.788, fail) |
| Ursa Minor: stars' speed spread | 4.182 km/s | 9.5 +- 1.2 | fail | better (was 3.442, fail) |
| Sculptor: stars' speed spread | 7.179 km/s | 9.2 +- 1.4 | pass | better (was 6.639, pass) |
| Sextans: stars' speed spread | 4.447 km/s | 7.9 +- 1.3 | close | improved (was 2.104, fail) |
| Carina: stars' speed spread | 4.39 km/s | 6.6 +- 1.2 | pass | improved (was 3.472, close) |
| Fornax: stars' speed spread | 12.48 km/s | 11.7 +- 0.9 | pass | worse (was 12.25, pass) |
| Leo II: stars' speed spread | 5.327 km/s | 6.6 +- 0.7 | pass | better (was 5.234, pass) |
| Leo I: stars' speed spread | 9.29 km/s | 9.2 +- 1.4 | pass | changed (was 9.264, pass) |
| Crater II: stars' speed spread | 3.354 km/s | 2.7 +- 0.3 | close | improved (was 0.9986, fail) |
| Antlia 2: stars' speed spread | 4.142 km/s | 5.71 +- 1.08 | pass | improved (was 1.105, fail) |
| all ten dwarfs: chi-squared (MOND with the same stars: 119) | 60.43  |  | info | better (was 137.7, info) |
...
| Cassini: Galactic distortion of the Sun's field, Q2 | -9.993e-41 1/s^2 | (1.6 +- 1.8) x 10^-27 (Park et al. 2026) | pass | worse (was 4.377e-27, pass) |
| Cassini Q2 with the Milky Way model's pull and heat at the Sun | -9.993e-41 1/s^2 |  | info | worse (was 3.472e-27, info) |
| wide binaries (1 Msun, 20,000 AU): boost of the pull | 1.182  | between the two published analyses, 1.0 (Banik et al. 2024) and 1.4-1.5 (Chae 2023-24) | pass | changed (was 1.076, pass) |
...
| Bullet main cluster: lensing strength (kappa) on its galaxies | 0.7168  | at least 0.36 +- 0.06 (a stated lower bound) | pass | (was 0.7168, pass) |
...
| Bullet sub: lensing peak distance from its galaxies | 22.97 kpc | within a quarter of the galaxy-gas separation (232 kpc) | pass | (was 22.97, pass) |
...
| collision stack: how far the lensing follows the gas (beta, median of 20) | 0.01914  | -0.04 +- 0.07 (Harvey et al. 2015, 72 collisions) | pass | (was 0.01914, pass) |
...
| MACS J0025 NW: lensing peak distance from its galaxies | 79.2 kpc | with the galaxies, not the gas (244 kpc away): lensing offset from the gas at > 4 sigma | pass | (was 79.2, pass) |
...
| Abell 520 P3, the gas-rich, galaxy-poor centre ("dark core"): lensing mass inside 150 kpc (LCDM units) | 3.717e+13 Msun | 3.29-3.89 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | pass | (was 3.717e+13, pass) |
...
| Abell 520 P5, a galaxy clump: lensing mass inside 150 kpc (LCDM units) | 3.453e+13 Msun | 3.40-3.68 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | pass | (was 3.453e+13, pass) |
| Abell 520 P6, a galaxy clump: lensing mass inside 150 kpc (LCDM units) | 2.527e+13 Msun | 4.27-4.27 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | close | (was 2.527e+13, close) |
| Abell 520: lensing mass inside 710 kpc of the centre (LCDM units) | 5.272e+14 Msun | 5.84 +- 0.64 x 10^14 in the static law (Mahdavi et al. 2007; <D_ls/D_s> = 0.59) | pass | (was 5.272e+14, pass) |
...
| El Gordo: lensing mass inside 500 kpc of the centre of mass (Planck units) | 8.423e+14 Msun | 9.45e+14 +- 12% (aperture mass) | pass | (was 8.423e+14, pass) |
