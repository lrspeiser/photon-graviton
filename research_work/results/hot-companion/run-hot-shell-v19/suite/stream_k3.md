# Regression suite: stream_k3 (quick tier)

Law: a = 6.2979e-11 m/s^2; g_d = 2.0273e-10 m/s^2 (lambda 3.219); u = 169.4 km/s; reach 2.25 Mpc; gradual release over 3e+04 AU; distance scale alpha x0.9500 (H0-like 70.9); SPARC distances static; heard through a stream absorbing inward waves at 3/Mpc

Round 19: the hot and the clusters' cold glow heard through a stream that absorbs inward-travelling waves at 3 per Mpc (absorption length 333 kpc); constants as adopted (no refit).

Run 2026-09-25 03:30 UTC on commit 36e6ef5+changes, 28 s. Baseline: baseline.json (round12, full, 2026-09-24 04:37 UTC).
...
| SPARC pull is not a function of g_N alone | 0.02748 dex | >= 0.005 dex beyond a local function of g_N | pass | (was 0.02749, pass) |
...
| SPARC typical speed miss (validation galaxies) | 19.02 km/s | no worse than MOND (19.80); within 5% is close | pass | (was 19.01, pass) |
...
| SPARC median residual where the release switches (g_N 10^-10.25 to 10^-9.5) | 0.02707 dex | 0 +- 0.02 dex | pass | (was 0.02706, pass) |
| bulge-dominated galaxies (25): typical speed miss | 29.43 km/s | no worse than MOND (30.35) | pass | (was 29.44, pass) |

## clusters

| Check | Ours | Measured / required | Status | vs baseline |
|---|---:|---|---|---|
| X-COP: typical mass miss, rms ln(M_hydrostatic/M_predicted) (static distances) | 0.2584  | <= 0.30 (hydrostatic masses carry 10-20% bias and error); MOND 1.06, NFW fit 0.10 | pass | worse (was 0.2215, pass) |
| X-COP: worst mean miss at any of the six radii (0.1-1 R500) | 0.2854  | <= 0.25 (the usual hydrostatic bias at R500) | close | REGRESSED (was 0.2389, pass) |
| the companion speed X-COP prefers for these a and g_d | 140.8 km/s | law uses 169.4 | info | worse (was 169.4, info) |
...
| SLACS: stellar mass from lensing minus from star speeds (mean of 6) | -0.02716 dex | 0 +- 0.023 (the lenses' own scatter) | pass | changed (was -0.02775, pass) |
...
| rotation curve 15-27 kpc: mean offset over the four Gaia analyses | -8.68 km/s | 0 +- 5 (the analyses differ by about 10) | pass | (was -8.672, pass) |
| rotation curve 5-27 kpc: typical miss against Eilers et al. 2019 | 15.95 km/s |  | info | (was 15.94, info) |
...
| escape speed at the Sun (to 400 kpc) | 504.3 km/s | 445-580 (seven analyses 2014-2024) | pass | (was 504.4, pass) |
