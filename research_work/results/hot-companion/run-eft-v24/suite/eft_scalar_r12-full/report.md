# Regression suite: eft_scalar_r12 (full tier)

Law: a = 6.2979e-11 m/s^2; g_d = 2.0273e-10 m/s^2 (lambda 3.219); u = 169.4 km/s; reach 2.25 Mpc; gradual release over 3e+04 AU; distance scale alpha x0.9500 (H0-like 70.9); SPARC distances static; collision maps: eft_scalar (code/eft_field_v24.py)

Round 24, the proposed repair of the Casimir-EFT note: the heat enters the nonlinear equation as the companion's energy density heard from all around (the law's scalar S), L = -|grad phi|^3/(12 pi G a) + S |grad phi|/(4 pi G) - rho phi, i.e. div[(|grad phi|/a - S/|grad phi|) grad phi] = -div F, with F the cold companion's flux (the law's memory). Spherical tests: identical to the law (two-way S). Collision maps: code/eft_field_v24.py mode 'eft_scalar' (the field along F, the curl field neglected). Strong-field hold kept. Registered comparison, not adopted.

Run 2026-09-26 07:02 UTC on commit 32e04ba+changes, 906 s. Baseline: baseline.json (round12, full, 2026-09-24 04:37 UTC).
...
| vs baseline: worse | 10 |
| vs baseline: better | 3 |
| vs baseline: changed | 11 |
| vs baseline: new | 0 |
| vs baseline: known | 6 |
| vs baseline: error | 0 |
...
| Bullet main cluster: lensing strength (kappa) on its galaxies | 0.65  | at least 0.36 +- 0.06 (a stated lower bound) | pass | changed (was 0.7168, pass) |
| Bullet subcluster: lensing strength (kappa) on its galaxies | 0.3122  | at least 0.20 +- 0.05 (a stated lower bound) | pass | changed (was 0.2764, pass) |
| Bullet: leftover lensing on the main cluster's gas | 0.09228  | 0.05 +- 0.06 | pass | worse (was 0.04957, pass) |
| Bullet: leftover lensing on the subcluster's gas | 0.07371  | 0.02 +- 0.06 | pass | worse (was 0.0516, pass) |
| Bullet main: lensing peak distance from its galaxies | 56.62 kpc | within a quarter of the galaxy-gas separation (252 kpc) | pass | worse (was 15.68, pass) |
| Bullet sub: lensing peak distance from its galaxies | 33.23 kpc | within a quarter of the galaxy-gas separation (232 kpc) | pass | worse (was 22.97, pass) |
| Bullet main cluster: lensing mass inside 301 kpc (250 in LCDM units) | 2.842e+14 Msun | 3.09-3.46 x 10^14 (Paraficz 2016; Bradac 2006; converted) | pass | worse (was 2.969e+14, pass) |
| Bullet subcluster: lensing mass inside 301 kpc (250 in LCDM units) | 1.583e+14 Msun | 2.47-2.85 x 10^14 (Paraficz 2016; Bradac 2006; converted) | fail | better (was 1.385e+14, fail) |
| collision stack: how far the lensing follows the gas (beta, median of 20) | 0.02297  | -0.04 +- 0.07 (Harvey et al. 2015, 72 collisions) | pass | changed (was 0.01914, pass) |
| collision stack: lensing peak distance from the galaxies (median) | 34.68 kpc | raw offset; includes the pull of the other cluster | info | changed (was 15.75, info) |
| MACS J0025 SE subcluster: lensing mass inside 300 kpc (LCDM units; 429 kpc static) | 1.917e+14 Msun | 3.64 (+1.46/-2.48) x 10^14 | pass | changed (was 2.053e+14, pass) |
| MACS J0025 NW subcluster: lensing mass inside 300 kpc (LCDM units; 429 kpc static) | 2.009e+14 Msun | 3.79 (+0.73/-2.04) x 10^14 | pass | changed (was 1.853e+14, pass) |
| MACS J0025 SE: lensing peak distance from its galaxies | 115.2 kpc | with the galaxies, not the gas (530 kpc away): lensing offset from the gas at > 4 sigma | pass | worse (was 23.61, pass) |
| MACS J0025 NW: lensing peak distance from its galaxies | 223.4 kpc | with the galaxies, not the gas (244 kpc away): lensing offset from the gas at > 4 sigma | fail | REGRESSED (was 79.2, pass) |
...
| Abell 520 P1, a galaxy clump: lensing mass inside 150 kpc (LCDM units) | 2.952e+13 Msun | 2.44-3.26 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | pass | changed (was 3.158e+13, pass) |
| Abell 520 P2, a galaxy clump: lensing mass inside 150 kpc (LCDM units) | 5.535e+13 Msun | 4.70-4.83 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | pass | better (was 6.056e+13, pass) |
| Abell 520 P3, the gas-rich, galaxy-poor centre ("dark core"): lensing mass inside 150 kpc (LCDM units) | 4.315e+13 Msun | 3.29-3.89 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | pass | worse (was 3.717e+13, pass) |
| Abell 520 P4, a galaxy clump: lensing mass inside 150 kpc (LCDM units) | 3.332e+13 Msun | 4.91-6.48 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | pass | worse (was 4.117e+13, pass) |
| Abell 520 P5, a galaxy clump: lensing mass inside 150 kpc (LCDM units) | 3.637e+13 Msun | 3.40-3.68 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | pass | changed (was 3.453e+13, pass) |
| Abell 520 P6, a galaxy clump: lensing mass inside 150 kpc (LCDM units) | 2.987e+13 Msun | 4.27-4.27 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | pass | improved (was 2.527e+13, close) |
| Abell 520: lensing mass inside 710 kpc of the centre (LCDM units) | 5.361e+14 Msun | 5.84 +- 0.64 x 10^14 in the static law (Mahdavi et al. 2007; <D_ls/D_s> = 0.59) | pass | better (was 5.272e+14, pass) |
...
| El Gordo: lensing mass inside 500 kpc of the centre of mass (Planck units) | 8.445e+14 Msun | 9.45e+14 +- 12% (aperture mass) | pass | changed (was 8.423e+14, pass) |
| El Gordo: lensing mass inside 1000 kpc of the centre of mass (Planck units) | 2.148e+15 Msun | 2.43e+15 +- 12% (aperture mass) | pass | changed (was 2.142e+15, pass) |
...
| El Gordo SE: lensing peak distance from the cool gas core | 252.0 kpc | about 12 arcsec, the lensing peak nearer the merger centre (Kim et al. 2021; Ng et al. 2015) | info | changed (was 248.4, info) |
