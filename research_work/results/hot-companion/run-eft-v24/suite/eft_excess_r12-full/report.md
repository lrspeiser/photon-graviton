# Regression suite: eft_excess_r12 (full tier)

Law: a = 6.2979e-11 m/s^2; g_d = 2.0273e-10 m/s^2 (lambda 3.219); u = 169.4 km/s; reach 2.25 Mpc; gradual release over 3e+04 AU; distance scale alpha x0.9500 (H0-like 70.9); SPARC distances static; collision maps: eft_excess (code/eft_field_v24.py)

Round 24, the proposed repair of the Casimir-EFT note, kept as close to the note as possible: its source rho + k rho_stars (the net flow of the cold and hot glow, with the law's memory on the collision maps) plus one term for the part of the hot glow's intensity that does not add up to a net flow, S_ex = S - |g_hot| >= 0: L = -|grad phi|^3/(12 pi G a) + S_ex |grad phi|/(4 pi G) - rho_phi phi. Spherical tests: identical to the law (two-way S). Collision maps: code/eft_field_v24.py mode 'eft_excess' (curl field neglected). Strong-field hold kept. Registered comparison, not adopted.

Run 2026-09-26 06:46 UTC on commit 32e04ba+changes, 946 s. Baseline: baseline.json (round12, full, 2026-09-24 04:37 UTC).
...
| Bullet main cluster: lensing strength (kappa) on its galaxies | 0.718  | at least 0.36 +- 0.06 (a stated lower bound) | pass | changed (was 0.7168, pass) |
| Bullet subcluster: lensing strength (kappa) on its galaxies | 0.2764  | at least 0.20 +- 0.05 (a stated lower bound) | pass | (was 0.2764, pass) |
| Bullet: leftover lensing on the main cluster's gas | 0.0499  | 0.05 +- 0.06 | pass | changed (was 0.04957, pass) |
| Bullet: leftover lensing on the subcluster's gas | 0.05178  | 0.02 +- 0.06 | pass | changed (was 0.0516, pass) |
| Bullet main: lensing peak distance from its galaxies | 15.75 kpc | within a quarter of the galaxy-gas separation (252 kpc) | pass | changed (was 15.68, pass) |
| Bullet sub: lensing peak distance from its galaxies | 22.96 kpc | within a quarter of the galaxy-gas separation (232 kpc) | pass | (was 22.97, pass) |
| Bullet main cluster: lensing mass inside 301 kpc (250 in LCDM units) | 2.971e+14 Msun | 3.09-3.46 x 10^14 (Paraficz 2016; Bradac 2006; converted) | pass | (was 2.969e+14, pass) |
...
| collision stack: how far the lensing follows the gas (beta, median of 20) | 0.01942  | -0.04 +- 0.07 (Harvey et al. 2015, 72 collisions) | pass | changed (was 0.01914, pass) |
| collision stack: lensing peak distance from the galaxies (median) | 15.81 kpc | raw offset; includes the pull of the other cluster | info | changed (was 15.75, info) |
| MACS J0025 SE subcluster: lensing mass inside 300 kpc (LCDM units; 429 kpc static) | 2.059e+14 Msun | 3.64 (+1.46/-2.48) x 10^14 | pass | changed (was 2.053e+14, pass) |
...
| MACS J0025 SE: lensing peak distance from its galaxies | 25.33 kpc | with the galaxies, not the gas (530 kpc away): lensing offset from the gas at > 4 sigma | pass | changed (was 23.61, pass) |
| MACS J0025 NW: lensing peak distance from its galaxies | 83 kpc | with the galaxies, not the gas (244 kpc away): lensing offset from the gas at > 4 sigma | pass | changed (was 79.2, pass) |
...
| Abell 520 P2, a galaxy clump: lensing mass inside 150 kpc (LCDM units) | 6.071e+13 Msun | 4.70-4.83 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | pass | changed (was 6.056e+13, pass) |
| Abell 520 P3, the gas-rich, galaxy-poor centre ("dark core"): lensing mass inside 150 kpc (LCDM units) | 3.716e+13 Msun | 3.29-3.89 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | pass | (was 3.717e+13, pass) |
| Abell 520 P4, a galaxy clump: lensing mass inside 150 kpc (LCDM units) | 4.150e+13 Msun | 4.91-6.48 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | pass | changed (was 4.117e+13, pass) |
...
| Abell 520 P6, a galaxy clump: lensing mass inside 150 kpc (LCDM units) | 2.506e+13 Msun | 4.27-4.27 x 10^13 in the static law (Jee et al. 2014; Clowe et al. 2012) | close | changed (was 2.527e+13, close) |
| Abell 520: lensing mass inside 710 kpc of the centre (LCDM units) | 5.273e+14 Msun | 5.84 +- 0.64 x 10^14 in the static law (Mahdavi et al. 2007; <D_ls/D_s> = 0.59) | pass | (was 5.272e+14, pass) |
...
| El Gordo: lensing mass inside 500 kpc of the centre of mass (Planck units) | 8.425e+14 Msun | 9.45e+14 +- 12% (aperture mass) | pass | (was 8.423e+14, pass) |
...
| El Gordo SE: lensing peak distance from the cool gas core | 250.2 kpc | about 12 arcsec, the lensing peak nearer the merger centre (Kim et al. 2021; Ng et al. 2015) | info | changed (was 248.4, info) |
