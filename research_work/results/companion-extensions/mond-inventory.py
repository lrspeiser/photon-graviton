...
python mond-inventory.py [--output-dir DIR] [--canonical]
Regenerates into a fresh directory and compares with the archived
mond-inventory-results.json; only --canonical overwrites the archive. The
...
def compute():
 ...
 a0=controls['MOND_a0_SI']*3.085677581491367e19/1e6
 cat={}
...
def main():
 ...
 out=compute()
 return evidence_io.finish(args,'mond-inventory',json.dumps(out,indent=2)+'\n',P/'mond-inventory-results.json',
                           ignore=['/source_sha256/research_work/results/companion-extensions/mond-inventory.py'])
