...
**Chosen-law/rate clarification:** the large delay is not measured or a generic photon-conversion prediction. The inverse-affine travel law is a postulate and alpha is an exposed-data redshift calibration. A post-result [rate sensitivity](rate-sensitivity.json) gives approximately 655,000–695,000 years over its earlier calibration range. Reducing the rate enough for the illustrative ten-second source-lag scenario also reduces the predicted transfer redshift to about 5.63e-15. Changing propagation or messenger coupling is a different candidate. The [photon-generated gravity-wave branch](../../../research_plan/photon-generated-gravitational-waves.md) separates known whole-mode conversion from the project's desired partial energy-loss channel.
