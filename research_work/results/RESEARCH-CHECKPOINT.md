...
Latest result: [finite radiation trains](radiation-train/report.md). Eight coupled finite-source backgrounds and 104 carrier/event comparisons test packet spacing at fixed incoming power. Closer arrivals reduce sampled residual variation, while mean redshift and a continuing drift depend on radiation power. Startup versus long-term evolution remains unresolved. The companion receives the accounted photon loss; no stationary cosmic population, matter-clock completion, capture or gravity is derived.
