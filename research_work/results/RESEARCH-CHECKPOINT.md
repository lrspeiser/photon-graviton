...
Latest result: [sustained illumination](sustained-illumination/report.md). A derived rolling-field branch predicts nearly steady signal stretching despite a growing field. Six longer finite-source backgrounds and 60 carrier/event comparisons approach its redshift and energy-rate predictions. The energy ledger separates companion production from photon energy still in transit. Next test three-dimensional spreading and localized versus extended illumination; no dimensional extrapolation, matter clocks, capture or gravity completion is established.
