...
Execution update, 20 September 2026: [SR-1](../research_work/experiments/common_cone/spatial-report.md) implements the spatial-response Hamiltonian, including all reciprocal derivatives, and passes its local controls plus eight enlarged-box evolutions and ten comparisons. The original boundary-clearance failures are retained. Lensing accuracy is not yet established: the bend changes 11.17% on spatial refinement. Lambda feedback is derivative-tested only, not evolved as a formation claim. [RB-1](../research_work/experiments/common_cone/radiation-budget-report.md) additionally shows that the weak outgoing-wave branch can have an outer 1/r acceleration, but all 54 declared fuel budgets fail the ten-billion-year target. Retaining an equivalent positive-energy wave inventory remains expensive. The next mechanism must demonstrate affordable response, not merely the desired radial shape or longer storage; the full source, stability, local-limit and observational requirements remain in force.
