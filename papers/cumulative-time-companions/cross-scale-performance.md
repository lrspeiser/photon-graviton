...
RB-1 is not promoted. The general lesson is that an external isotropic bath cannot build an extended reservoir through ordinary-matter receivers. The next calculation is the momentum budget of companions generated by a rotating disk's own starlight. PDF v1.5 predates this supplement.
