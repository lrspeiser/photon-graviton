...
- **Letting the groove take time to form changes that.** If a fresh disturbance only becomes a force after a delay, rather than immediately, the same bodies from the same starting conditions hold nearly all their angular momentum instead of a fifth of it, and the groove pulls them inward as intended rather than outward. Nothing about the settled strength of the field was altered to achieve this. Whether such an arrangement finally stops drifting, over much longer times and from less orderly beginnings, is the next thing to find out.
