...
1. an exact principal-axis transverse block of the same finite link operators;
...
def axial_components(spin: int, lattice_size: int):
    """Build one exact transverse flux block in the zero-total-flux sector."""
