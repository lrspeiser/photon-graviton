...
- **Latest: [broadband receiver response](research_work/results/broadband-capture/derivation.md).** A scalar oscillator yields an explicit absorption response, but cancellation of orbital slowing depends on the incident spectrum. Regular passive absorption in an isotropic thermal-spectrum bath retains positive slowing. Companions are not assumed thermal; their actual spectrum must be derived from production.
