...
- **Latest: [slower companion-wave emission](research_work/results/slow-companion/derivation.md).** A specified scalar/electric interaction derives energy transfer and photon deflection together. Its fractional loss grows as photon energy cubed; making packets small produces broad deflections. This candidate fails the required achromatic drift in its stated domain, while providing a reusable joint-kernel comparison.
