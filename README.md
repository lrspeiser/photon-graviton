...
- **Latest: [companion-field backreaction and energy flow](research_work/results/companion-backreaction/report.md).** A candidate interaction conserves photon-plus-companion energy and momentum and transports field energy away from the light route. Its radiation-loading dependence must be resolved before claiming a common astronomical stretching law.
