...
- **Latest: [dispersive companion-wave emission](research_work/results/dispersive-companion/derivation.md).** An explicit dispersion scale permits small energy packets and small deflections together. The same electric vertex retains at least linear color dependence in the full-band regime, so this improvement does not establish achromatic redshift.
