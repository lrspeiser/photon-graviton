...
- **Latest: [generated companion waves entering a restoring region](research_work/results/generated-wave-access/report.md).** A joint photon/field/slab calculation now produces the incoming waves dynamically. The tested sources put most energy below the region's transmission threshold; only about 0.15-0.17% passes through the m=1 example. Energy is conserved, and temporary field energy is not counted as a permanent deposit. This constrains the tested source/environment combination, not every cumulative-time law.
