...
- **Latest: [background replenishment](research_work/results/background-replenishment/derivation.md).** Emission alone cannot hold a fixed-volume Planck background steady under photon-energy conversion. A simple frequency-independent removal model needs a removal rate at least twice the conversion rate and source power at least three times the gradual-conversion power. This inverse requirement does not derive an actual emitter or background history.
