...
- **Latest: [cumulative time stretching with companion transfer](research_work/results/cumulative-time/report.md).** One whole-signal stretch links redshift, event duration, brightness and the agreed companion-energy gain. A prescribed void propagation example passes mathematical checks; a fundamental time/companion interaction and gravity response remain to be derived.
