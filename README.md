...
- **Latest: [integrated timing pilot](research_work/results/timing-population/report.md).** All 98 events enter a joint uncertainty calculation, but the numerical convergence gate fails despite a stable aggregate slope. The [void-time clarification](research_plan/void-time-clarification.md) records the intended cumulative stretching during travel, with its next physical checks.
