...
- **Latest: [heated thermalizer](research_work/results/thermalizer/derivation.md).** Thermal emission tied to absorption gives a calculable stationary spectrum. Rapid thermalization approaches the recovered microwave spectrum, while requiring external heating and erasing incoming angular structure. The actual material and background history are not established.
