...
- **Latest: [finite radiation trains](research_work/results/radiation-train/report.md).** More frequent, smaller radiation packets reduce sampled residual variation at fixed incoming power, but a substantial drift remains. Eight refined backgrounds and 104 carrier/event comparisons pass; the failed coarse-grid pilot is retained. A steady source population, environmental law, matter clocks, capture and gravity are not established.
