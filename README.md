...
- **Latest: [joined source and receiver](research_work/results/source-receiver/derivation.md).** The converter-generated spectrum now feeds capture and escape in an explicit energy ledger. Matching the resonances does not cancel slowing; capture strength changes both efficiency and spectral weighting. This does not repair the converter's known color/angle failures.
