...
- **Latest: [uncertain-duration likelihood component](research_work/results/timing-likelihood/report.md).** The revised timing method begins with a verified probability calculation that integrates uncertain positive brightness and background. The complete duration/population estimator and its injection calibration remain unfinished; no real-data timing claim is made.
