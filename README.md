...
- **Latest: [environmental field suppression and wave transmission](research_work/results/environmental-screening/report.md).** A candidate restoring term can reduce slow field changes inside a region while admitting rapid companion waves. Its frequency cutoff must be matched to an actual companion spectrum; the lossless model does not capture energy.
