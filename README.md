...
- **Latest: [source-timescale and delivery tradeoff](research_work/results/source-timescale/report.md).** A narrower tested conversion region produces faster oscillations and delivers about 47 times more energy through the same m=1 restoring slab, despite producing less photon energy loss. Eighteen refined runs pass the numerical checks; the initial failed grid-convergence pilot is retained. Region sizes, cumulative timing, clocks, capture and gravity remain unproved.
