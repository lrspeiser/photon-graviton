...
- **Latest: [sustained illumination](research_work/results/sustained-illumination/report.md).** Longer finite illumination approaches a derived rolling-field branch with nearly steady redshift and event stretching. Six refined backgrounds and 60 carrier/event comparisons account for companion production and growing photon energy in transit. Three-dimensional propagation, environmental dynamics, matter clocks, capture and gravity remain unproved.
