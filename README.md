...
- **Latest: [candidate decisions and priorities](research_work/results/candidate-review/review.md).** The review distinguishes failed core mechanisms from reusable capture/background calculations and untested extensions. No single tested candidate supplies the complete chain. The next priority is a derived interaction kernel with consistent timing and detector standards; all 20 tasks and 32 requirements remain in scope.
