...
- **Latest: [electric/magnetic balance](research_work/results/electromagnetic-balance/derivation.md).** Constant electric, magnetic and parity-odd couplings cannot cancel the color dependence across an open full-band interval. The best high-energy twofold-band mixture still has an 8.30% uniform rate-flatness error. This is a mathematical source-kernel limitation, not an observed redshift-error estimate.
