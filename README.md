...
- **Latest: [thermal conversion and FIRAS](research_work/results/thermal-conversion/derivation.md).** Photon-preserving energy loss in a fixed volume changes blackbody normalization. A simplified comparison with the recovered 43-channel microwave spectrum disfavors appreciable loss for an initially thermal, unreplenished bath. This conditional diagnostic does not establish a background origin or exclude every conversion model.
