...
- **Latest: [dynamical matched waves](research_work/results/matched-wave/derivation.md).** An explicit electromagnetic action yields common frequency scaling and conserved transfer into a propagation field, beyond the slowly varying approximation. The same minimal coupling changes atomic standards and gives the wrong observed shift sign with fixed masses/charges. This is a tested comparison, not an adopted solution.
