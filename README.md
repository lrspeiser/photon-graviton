...
- **Latest: [weak-signal timing in the companion field](research_work/results/weak-signal-timing/report.md).** Faint test signals share a local frequency/event-time stretch in the candidate field. Changes in that field can distort longer events; its environmental state and physical clock response remain to be derived.
