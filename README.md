...
- **Latest: [populated companion bath](research_work/results/companion-bath/derivation.md).** Accumulated companions can return energy to photons and increase energy fluctuations. Fixed isotropic occupation does not repair the tested color law, and thermal soft modes need consistent infrared treatment. These local energy moments do not establish a bath history, spectral fit or permanent deposit.
