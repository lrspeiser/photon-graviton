...
## Status — 23 September 2026 (hot-companion rows updated after round 5)
...
**Next, after round 5 (hot-companion gravity):**

1. **The Bullet subcluster's pre-collision size** (about 1:3 in visible matter by our law): find
   the stars that came with it (about 7 × 10¹² M☉), and check the shock and X-ray shape of a
   collision this size.
