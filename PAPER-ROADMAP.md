...
## Status — 23 September 2026 (hot-companion rows updated after round 8)
...
**Next, after round 8 (hot-companion gravity):** every item is run through the regression suite.
...
2. **Adopt gradual release** (costs nothing in the suite) after a full-tier run and refit.
